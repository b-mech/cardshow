...
function renderCart() {
  ...
  cartItems.forEach((item, index) => {
    ...
    cartItem.style.setProperty("--index", String(index));
    cartItem.style.setProperty("--count", String(cartItems.length));
    ...
    fanTrack.appendChild(cartItem);
  });

  cartSlider.appendChild(fanTrack);
  updateTimers();
}
